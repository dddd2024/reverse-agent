...
static void build_key72(const uint8_t prefix7[PREFIX_LEN], uint8_t key[88]) {
...
static void write_entry_json(FILE *fp, const Entry *entry, const char *source_pool) {
    ...
    fprintf(
        fp,
        "{\"cand9_hex\":\"%s\",\"candidate_hex\":\"%s41414141414141\",\"lhs_prefix_hex\":\"%s\","
