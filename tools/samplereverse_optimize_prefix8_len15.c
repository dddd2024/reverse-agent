...
#define FAR_JUMP_INTERVAL 100000ULL
...
static const char *FIXED_SEEDS[] = {
    /* L15 exact-2 -> exact-3 progression seeds */
    "137846e6e8991bf0",
    "137880eae8991bf0",
    "9a7880eae84313f0",
    "0e7880ea7c7a1bf0",
    ...
    "1b1e80eae899f9f0",
    "13286ceae899f2f0",
    /* Keep a few cross-basin seeds to avoid collapsing into one prefix family. */
    "e05e579fca169e80",
    "b45e5794ca019e80",
    "4023ccefccf92680",
    "9ae3d64bbffc1880",
...
static void build_key72(const uint8_t prefix7[PREFIX_LEN], uint8_t key[80]) {
...
static void write_entry_json(FILE *fp, const Entry *entry, const char *source_pool) {
    ...
    fprintf(
        fp,
        "{\"cand8_hex\":\"%s\",\"candidate_hex\":\"%s41414141414141\",\"lhs_prefix_hex\":\"%s\","
